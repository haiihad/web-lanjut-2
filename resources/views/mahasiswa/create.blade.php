...
@section('content')
    ...
    <div class="form-group row">
     ...
     <div class="col-sm-3">
        <input type="text" name="npm" class="form-control" id="nim" placeholder="Nomor Pokok Mahasiswa">
        @error('npm')<small id="npm" class="form-text text-danger">{{ $message}}</small>@enderror
     </div>
    </div>
    <div class="form-group row">
